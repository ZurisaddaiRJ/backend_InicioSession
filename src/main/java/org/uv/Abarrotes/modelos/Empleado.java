...
//        this.contrasenia = passwordEncoder.encode(contrasenia);
//    }
    public Rol getRoles() {
        return roles;
    }
...
//        BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
//        return passwordEncoder.matches(contrasenia, this.contrasenia);
//    }
//    // Método para verificar si el objeto está vacío Para generar rol del jefe y gerente
//    public boolean isEmpty() {
//        return Stream.of(nombre, apellidos, contrasenia, roles)
