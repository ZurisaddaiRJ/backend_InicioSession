...
//    //Metodo para generar JEF y GERENTE
//    public Rol crearRol(String cve) {
//        Rol rol = new Rol();
//        rol.setCve(cve);
...
//        if (rolRepository.findByCve("EMPLEADO").isEmpty()) {
//            // Si no existe, crea el rol por defecto "Empleado"
//            Rol rolEmpleado = new Rol("EMPLEADO", "Empleado");
